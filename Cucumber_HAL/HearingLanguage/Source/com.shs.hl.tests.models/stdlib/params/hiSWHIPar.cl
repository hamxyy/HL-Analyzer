/* API_major:1: API_minor:5: created:2013-JULY-5 0:57: hsml_branch:hsmlData8.2.00014outputhsmlData: */
/* B_hsmlData_8.2.0.0014_2013-06-12#B_FittingHIDBInterfaces_7.3.0.0025_2013-07-05 */
...
hi ordered enum d8SwChanOutLim_Bb 13175 {
	_0dB = 0,
	M3dB = 1,
	M6dB = 2,
	M9dB = 3,
...
{-0.99999988079071,0.99999988079071};
...
/$Enable or disable the LED of the hearing instrument. Should be set to off if no LED is present.$/
